        ...
        {menuOpen && (
          ...
          >
            ...
            >
              ...
              {/* WhatsApp CTA mobile */}
              <a
                href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Bonjour, je souhaite des informations sur vos tours au Maroc.")}`}
                target="_blank"
                rel="noopener noreferrer"
                className="mt-6 flex items-center justify-center gap-2.5 rounded-xl px-4 py-3.5 font-medium text-white transition-opacity hover:opacity-90"
