...
import { Locale, SITE_NAME, INSTAGRAM_URL, TIKTOK_URL, WHATSAPP_NUMBER } from "@/lib/site";
        ...
        <div className="mx-auto w-full max-w-5xl px-4 py-12 text-sm">
          <div className="flex flex-col items-center gap-8 md:flex-row md:items-start md:justify-between">
            ...
            <div className="flex items-center gap-4">
              <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 transition-colors hover:text-gold">
                <InstagramIcon />
                <span>@dunaria</span>
              </a>
              <a href={TIKTOK_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 transition-colors hover:text-gold">
                <TikTokIcon />
                <span>@dunaria</span>
              </a>
            </div>
          ...
          <div className="mt-8 border-t border-white/10 pt-6">
            <div className="flex flex-col items-center gap-2 md:flex-row md:items-center md:justify-between">
              <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-xs text-white/30">
              ...
              <p className="flex items-center gap-1.5 text-xs text-white/20">
                Conçu par{" "}
                <a
                  href="https://www.linkedin.com/in/ali-khalouki"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-white/35 transition-colors hover:text-gold"
                >
