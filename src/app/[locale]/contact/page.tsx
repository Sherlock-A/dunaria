...
import { Locale, locales, SITE_URL, SITE_NAME, hreflangMap, WHATSAPP_NUMBER, CONTACT_EMAIL } from "@/lib/site";
      ...
      <FadeUp delay={0.2}>
        <div className="border-t border-sand-300 pt-8 text-center space-y-3">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-xs text-night-600/40 font-mono">
              {locale === "es" && "Respondemos en menos de 24 horas"}
              {locale === "en" && "We reply within 24 hours"}
              {locale === "fr" && "Réponse en moins de 24 heures"}
            </p>
          </div>
        </div>
      </FadeUp>
